...
The image above is the final visualisation. It plays straight from this page — the file is in `out/`, so opening it shows the animation without running anything. If you want to see it full size rather than embedded here, open [`out/aurora-waves-v04-week-in-motion.gif`](out/aurora-waves-v04-week-in-motion.gif) directly.
...
| File | What it is |
|---|---|
| `out/aurora-waves-v04-week-in-motion.gif` | The final animation: 161 frames, 17.7 seconds, about 3.6 MB. |
